package me.alpine.viamcp.platform;
...
import me.alpine.viamcp.utils.FutureTaskId;
...
public class MCPViaPlatform implements ViaPlatform<UUID>
{
    ...
    @Override public boolean disconnect(UserConnection connection, String message) {
    ...
    @Override public Collection<UnsupportedSoftware> getUnsupportedSoftwareClasses() {
        return ViaPlatform.super.getUnsupportedSoftwareClasses();
    }

    @Override public boolean hasPlugin(String s) {
        return false;
    }
}
