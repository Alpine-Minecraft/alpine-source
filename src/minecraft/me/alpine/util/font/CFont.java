...
public class CFont {
    ...
    @Getter protected boolean antiAlias;
    @Getter protected boolean fractionalMetrics;
    ...
    protected void drawQuad(double x, double y, float width, float height, float srcX, float srcY, float srcWidth, float srcHeight) {
